...
| Phase 3 | CI/CD・インフラ | [Milestone: Phase 3](https://github.com/ot-nemoto/link-hub/milestone/3) |
...
Vercel デプロイ設定と GitHub Actions による自動リリースを構築する。

**含む作業の概要:**
- Vercel プロジェクト設定（GitHub native 連携、develop→Preview / master→Production）
- GitHub Actions `release.yml` 追加（master マージ時にタグ + GitHub Release 自動作成）
